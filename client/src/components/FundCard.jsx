...
const FundCard = ({theme, owner, title, description, target, deadline, amountCollected, image, handleClick }) => {
  const remainingDays = daysLeft(deadline);
  
  return (
    <div className={`sm:w-[288px] w-full rounded-[15px] ${theme==="dark"?"bg-[#1c1c24]":"bg-gray-50 border shadow-md"} cursor-pointer`} onClick={handleClick}>
